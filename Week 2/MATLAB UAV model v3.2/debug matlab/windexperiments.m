...
wind_time=0:0.01:(length(windx)-1)*0.01;
simin_windx = timeseries(0*windx,wind_time);
simin_windy = timeseries(0*windy,wind_time);
...
hold on;
plot(timeb,totali); 
writematrix(totali,'current_matlab_nowind.txt')
