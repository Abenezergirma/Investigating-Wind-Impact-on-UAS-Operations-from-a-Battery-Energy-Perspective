...
headers = {'Trajectory Type', 'Speed', 'Wind X', 'Wind Y', 'Motor Affected', 'Full Loss', 'Partial Loss', 'Turbulence', 'Saturation RPM', 'Mean TTE', 'Sum TTE', 'Max TTE', 'Median TTE', 'Std TTE', 'TTF', 'TTC', 'Completed', 'TOC', 'Cross Corridor', 'Variance', 'Final SOC'};
...
for fault_idx = 1:57
    ...
    for wind_idx = 1:4
        ...
        for turb_idx = 1:2
            ...
            speed = 3 + (5 - 3)*rand;
            turbenabled=turb_idx-1;
            has_turbulence = turbenabled;
            ...
            maxleashvelocity=speed; % in m/s  SHOULD NOT BE LARGER THAN 7 M/S FOR NOW
        ...
        %{'Trajectory Type', 'Wind X', 'Wind Y', 'Motor Affected', 'Full Loss', 'Partial Loss', 'Turbulence', 'Saturation RPM', 'Mean TTE', 'Sum TTE', 'Max TTE', 'Median TTE', 'Std TTE', 'TTF', 'TTC', 'Completed', 'TOC', 'Cross Corridor', 'Variance'};
            curr_results = {trajtype, speed, windx, windy, motor_idx, is_full_loss, partial_percent, has_turbulence, saturation_num, mean_err, sum_err, max_err, median_err, std_err, ttf, ttc, completed, toc, num_crossings, jitter, SOC(end)};
